  ...
  return (
    <SelectPrimitive.Portal>
      <SelectPrimitive.Content
        ...
        style={{
          maxHeight:
            "min(var(--radix-select-content-available-height, 14rem), 14rem)",
          ...style
        }}
        {...props}
      >
        <SelectPrimitive.Viewport
          className={cn(
            "max-h-[inherit] overflow-y-auto overscroll-contain p-1 [scrollbar-width:thin] [&::-webkit-scrollbar]:w-2 [&::-webkit-scrollbar-thumb]:rounded-full [&::-webkit-scrollbar-track]:bg-transparent",
            isScrolling
              ? "[scrollbar-color:hsl(var(--muted-foreground)/0.35)_transparent] [&::-webkit-scrollbar-thumb]:bg-muted-foreground/30"
